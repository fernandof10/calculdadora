...
class Botao(Button):
    def __init__(self, tela,command, text):
        super().__init__(tela,command=command,text=text,height=1,width=4, font=("Helvetica", "18"))

b7 = Botao(frame_but, text='7',command=clk_7)
b7.grid(row=0, column=0)
b8 = Botao(frame_but, text='8', command=clk_8)
b8.grid(row=0, column=1)
b9 = Botao(frame_but, text='9', command=clk_9)
b9.grid(row=0, column=2)
bdiv = Botao(frame_but, text='\u00F7', command=clk_div)
bdiv.grid(row=0, column=3)
bac = Botao(frame_but, text='AC', command=clk_ac)
bac.grid(row=0, column=4)

b4 = Botao(frame_but, text='4', command=clk_4)
b4.grid(row=1, column=0)
b5 = Botao(frame_but, text='5', command=clk_5)
b5.grid(row=1, column=1)
b6 = Botao(frame_but, text='6', command=clk_6)
b6.grid(row=1, column=2)
bmult = Botao(frame_but, text='\u00D7', command=clk_mult)
bmult.grid(row=1, column=3)
bapag = Botao(frame_but, text='\u2190', command=clk_apag)
bapag.grid(row=1, column=4)

b1 = Botao(frame_but, text='1', command=clk_1)
b1.grid(row=2, column=0)
b2 = Botao(frame_but, text='2', command=clk_2)
b2.grid(row=2, column=1)
b3 = Botao(frame_but, text='3', command=clk_3)
b3.grid(row=2, column=2)
bneg = Botao(frame_but, text='-', command=clk_menos)
bneg.grid(row=2, column=3)
bres = Botao(frame_but, text='=', command=clk_res)
bres.grid(row=2, column=4, rowspan = 2,sticky = N+S)

b0 = Botao(frame_but, text='0', command=clk_0)
b0.grid(row=3, column=0, columnspan = 2, sticky = W+E)
bp = Botao(frame_but, text='.', command=clk_p)
bp.grid(row=3, column=2)
bm = Botao(frame_but, text='+', command=clk_mais)
